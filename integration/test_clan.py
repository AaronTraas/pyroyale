...
def test_clan_agrassar_members():
    api = pyroyale.ClansApi(pyroyale.ApiClient(configuration))

    try:
        members = api.get_clan_members('#JY8YVV')
...
def test_clan_agrassar_warlog():
    api = pyroyale.ClansApi(pyroyale.ApiClient(configuration))

    try:
        warlog = api.get_clan_war_log('#JY8YVV')
...
def test_clan_agrassar_current_war():
    api = pyroyale.ClansApi(pyroyale.ApiClient(configuration))

    try:
        war = api.get_current_war('#JY8YVV')
...
def test_clan_search_agrassar():
    api = pyroyale.ClansApi(pyroyale.ApiClient(configuration))

    try:
        clans = api.search_clans(name='agrassar')
