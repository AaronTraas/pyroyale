...
class ClanMember(PlayerBase):
    ...
    def __init__(self, role=None, clan_rank=None, previous_clan_rank=None, donations=None, donations_received=None, clan_chest_points=None):  # noqa: E501
